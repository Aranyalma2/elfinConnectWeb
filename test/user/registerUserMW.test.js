...
describe("Register User Middleware Tests", () => {
	it("should register a new user and set success message", (done) => {
		...
		const res = {
			locals: {
				texts: { registerSucces_Created: "User created successfully:" },
			},
		};
	...
	it("should registration save goes wrong", (done) => {
		...
		const res = {
			locals: {
				texts: { registerFailed_UnknownFail: "User creation falied" },
			},
		};
	...
	it("should handle existing username and set error message", (done) => {
		...
		const res = {
			locals: {
				texts: { registerFailed_Exists: "Username already exists:" },
			},
		};

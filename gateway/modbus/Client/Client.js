...
const exceptions = require("../ExceptionCodes");
const ReadStream = require("./ReadStream").ReadStream;
const WriteStream = require("./WriteStream").WriteStream;

const TRANSACTION_ID_LIMIT = 65535;

exports.Client = Client;

function Client(encapsulationHeader) {
	events.EventEmitter.call(this);

	let reader = new ReadStream();
	let writer = new WriteStream(encapsulationHeader);
	let responses = {};

...
function handleDragOver(event) {
	...
	let dragOverIndex = Array.from(event.target.closest("#cardContainer").children).indexOf(event.target.closest(".card"));
...
function handleDrop(event) {
	...
	const dragEndIndex = Array.from(event.target.closest("#cardContainer").children).indexOf(event.target.closest(".card"));
